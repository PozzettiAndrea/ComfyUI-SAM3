...
class Sam3TrackerPredictor(Sam3TrackerBase):
    ...
    def add_new_points_or_box(
        ...
        (
            ...
            is_cond,
            storage_key,
        ) = self._get_frame_context(inference_state, obj_idx, frame_idx)
        ...
        return self._consolidate_and_get_video_res_masks(
    ...
    def _consolidate_and_get_video_res_masks(self, inference_state, frame_idx, is_cond):
        obj_ids = inference_state["obj_ids"]
    ...
    def _get_frame_context(self, inference_state, obj_idx, frame_idx):
    ...
    def remove_object(self, inference_state, obj_id, strict=False, need_output=True):
        ...
        if need_output:
            ...
            for frame_idx in obj_input_frames_inds:
                ...
                _, _, _, video_res_masks = self._consolidate_and_get_video_res_masks(
                    inference_state, frame_idx, is_cond=is_cond
                )
...
class SAM3InteractiveImagePredictor(nn.Module):
    ...
    def set_image(self, image):
        ...
        feats = self._prepare_image_feats(backbone_out, batch_size=1)
    ...
    def set_image_batch(self, image_list):
        ...
        feats = self._prepare_image_feats(backbone_out, batch_size=batch_size)
        self._features = {"image_embed": feats[-1], "high_res_feats": feats[:-1]}
        self._is_image_set = True
        self._is_batch = True
        logging.info("Image embeddings computed.")

    def _prepare_image_feats(self, backbone_out, batch_size):
        (
            _,
            vision_feats,
            _,
